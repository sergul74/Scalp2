 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    adxs_full = df['adx_14'].values if 'adx_14' in df else np.full(len(df), 999.0)\n",
    "    \n",
    "    df_sim = df.iloc[bars]\n",
    "    \n",
    "    active_trade = None\n",
...
with open("notebooks/07_backtest_optimization.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1)
print("Notebook 07_backtest_optimization.ipynb created seamlessly!")
